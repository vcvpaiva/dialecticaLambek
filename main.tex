...
As hinted before these algebraic structrues have been studied before and, despite the order that we used here, the structure underlying the connection between the left and right implications and the tensor, which has traditionally been called a residuated structure is the most important one. It is worth noticing that surprising examples of these structures crop up in the work of Lawvere \cite{lawvere1973}. We recall two of these surprising examples, as they will be useful in the sequel.
