...
\subsection{The Lambek Calculus with the Weakening and Contraction Modality}
...
\begin{definition}
  \label{def:of-course}
  The following define the weakening and contraction modality of-course:
  \[
  \begin{array}{lll}
    \LdruleC{} & \LdruleW{}\\
    \\
...
\subsection{The Lambek Calculus with the Exchange Modality}
\label{subsec:the_lambek_calculus_with_the_exchange_modality}

\begin{definition}
  \label{def:exchange-modality}
  The following are the inference rules for the exchange modality:
  \[
  \begin{array}{lll}
    \LdruleEr{} & \LdruleEl{}\\
    \\
