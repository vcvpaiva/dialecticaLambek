...
cut-elimination procedure defined by a set of equations between
...
We can similarly interpret the rules for the exponential modality.
...
inference rules for the exponential modality can easily be interpreted
into the model.
