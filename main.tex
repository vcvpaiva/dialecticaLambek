...
\keywords{sequent calculus, dialectica categories, categorical model,
  linear logic, lambek calculus, modalities, structural rules,
  exchange, type theory}

%% MANDATORY 2012 ACM classification
%% see http://dl.acm.org/ccs.cfm
\ACMCCS{[{\bf Theory of computation}]: Linear Logic, Type Theory, Proof Theory}
\amsclass{18A15, 03B47, 03B70}
...
\begin{lem}[Type Preserving Embedding]
...
\begin{proof}
  ...
  typing derivation.
\end{proof}
\begin{lem}[Reduction Preserving Embedding]
